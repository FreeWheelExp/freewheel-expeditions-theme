...
.trip-hero{min-height:72vh;background:linear-gradient(145deg, #1a120a 0%, #0f1a18 50%, #0a0f08 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:100px 5vw 60px;position:relative;overflow:hidden}
...
<img id="tripHeroImg" src="" alt="Spiti Valley Self Drive Expedition 2026" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center;display:none;opacity:0.4;z-index:0">
<div class="trip-hero-content" style="position:relative;z-index:1">
    ...
    <h1 class="trip-h1">Spiti Valley Self Drive Expedition 2026</h1>
    ...
    <div class="trip-quick">
      ...
      <div class="tq-item"><div class="tq-label">Upcoming Dates</div><div class="tq-val">October 2026</div></div>
  ...
  <div class="trip-main">
    <div class="trip-grid">
      ...
      <div>
        ...
        <p class="overview-p">Spiti Valley, nestled within the rugged embrace of Himachal Pradesh's northern terrain, is a captivating testament to the wonders of nature and human resilience. This high-altitude desert region, aptly named 'The Middle Land' in Tibetan, unfolds its mystique through a tapestry of barren mountains, ancient monasteries, and remote villages.</p><p class="overview-p">Buddhist monasteries perched upon cliffs like silent sentinels stand as symbols of spiritual devotion in this isolated realm. Spiti's cultural fabric — woven with Tibetan influences — reveals warm hospitality, simple living, and vibrant festivals that echo through its valleys.</p><p class="overview-p">Amidst the challenges of altitude and ruggedness, Spiti Valley remains an enchanting sanctuary for those drawn to its raw beauty, tranquil spirituality, and the humbling harmony between humanity and the untamed wilderness.</p>
...
<section class="trip-gallery" id="gallery-spiti">
  ...
  <div class="tg-track" id="tgTrack-spiti">
      <div class="tg-slide" onclick="tgOpenLB('spiti',0)">
        <img src="https://images.unsplash.com/photo-1605649487212-47bdab064df7?w=1200&q=80" alt="Spiti Valley road" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('spiti',1)">
        <img src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=80" alt="Kunzum Pass Spiti" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('spiti',2)">
        <img src="https://images.unsplash.com/photo-1597240814775-a0e09ceee438?w=1200&q=80" alt="Pin Valley desert" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('spiti',3)">
        <img src="https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1200&q=80" alt="Milky Way Spiti" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('spiti',4)">
        <img src="https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=1200&q=80" alt="Key Monastery Spiti" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('spiti',5)">
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80" alt="Snow peaks Spiti" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
  </div>
...
var tgData = tgData || {};
tgData['spiti'] = [
        {src:"https://images.unsplash.com/photo-1605649487212-47bdab064df7?w=1200&q=80",cap:"Spiti Valley road"},
        {src:"https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=80",cap:"Kunzum Pass Spiti"},
        {src:"https://images.unsplash.com/photo-1597240814775-a0e09ceee438?w=1200&q=80",cap:"Pin Valley desert"},
        {src:"https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1200&q=80",cap:"Milky Way Spiti"},
        {src:"https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=1200&q=80",cap:"Key Monastery Spiti"},
        {src:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80",cap:"Snow peaks Spiti"}
];
  ...
  document.getElementById('tgLBCap').textContent = (tgCurrentLB+1)+' / '+arr.length+' — '+arr[tgCurrentLB].cap;
      ...
      <div class="sidebar">
        <div class="pay-panel">
          ...
          <div class="pc-alt"><span class="pc-alt-label">Seat Sharing</span><span class="pc-alt-price">&#8377;29999/person</span></div>
          <button class="book-big" onclick="openBookNow('Magical Spiti Valley',24999,'October 2026')">Book Now →</button>
        ...
        <div class="dates-card">
          ...
          <div class="dc-date">October 2026</div>
...
<section style="background:var(--rust);padding:60px 5vw;text-align:center">
  ...
  <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap">
    ...
    <a href="/cdn-cgi/l/email-protection#5e363b3232311e382c3b3b29363b3b323b262e3b3a372a3731302d703730" class="btn-ghost" style="border-color:rgba(255,255,255,.5);color:#fff">✉ Email Us</a>
  </div>
  <p style="margin-top:20px;font-size:13px;color:rgba(255,255,255,.7);font-weight:300"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="365e535a5a597650445353415e53535a534e4653525f425f595845185f58">[email&#160;protected]</a> · +91 78178 38060 · +91 78382 95852</p>
</section>

<?php fw_faq_section("spiti"); ?>
