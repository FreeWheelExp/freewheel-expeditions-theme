<?php
/**
 * Template Name: The Forbidden Mustang Expedition
 * Template Post Type: page
 *
 * FreeWheel Expeditions — The Forbidden Mustang Expedition
 * Template: page-nepal
 */
get_header(); ?>
<style>
...
.trip-hero{min-height:72vh;background:linear-gradient(145deg, #0a1820 0%, #1a2010 50%, #0f1808 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:100px 5vw 60px;position:relative;overflow:hidden}
...
<img id="tripHeroImg" src="" alt="Mustang Nepal Self Drive Expedition 2026" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center;display:none;opacity:0.4;z-index:0">
<div class="trip-hero-content" style="position:relative;z-index:1">
    ...
    <h1 class="trip-h1">Mustang Nepal Self Drive Expedition 2026</h1>
  ...
  <div class="trip-main">
    <div class="trip-grid">
      ...
      <div>
        ...
        <p class="overview-p">Nepal, a land where the Himalayas whisper ancient stories and spirituality flows through every valley, is a journey that transcends borders and touches the soul. Our Nepal Roadtrip is not just an expedition — it is an immersive experience through breathtaking landscapes, sacred temples, serene lakes, and timeless mountain villages.</p><p class="overview-p">From the tranquil beauty of Pokhara, where the majestic Annapurna range reflects over the still waters of Phewa Lake, to the sacred heights of Muktinath revered by both Hindus and Buddhists, this journey blends adventure with deep spiritual significance.</p><p class="overview-p">This roadtrip is designed for explorers who seek more than just destinations — those who crave mountain sunrises, meaningful conversations by the riverside, soulful temple bells at dusk, and the thrill of crossing international borders by road.</p>
        ...
        <div class="day-item">
          ...
          <div class="day-content">
            <div class="day-title">Delhi to Gorakhpur (850 km / ~13 hrs)</div>
            <div class="day-text">Depart from Delhi through the Indian countryside, passing through quaint towns and verdant fields. Stop at roadside dhabas for authentic North Indian cuisine. Arrive in Gorakhpur — a city steeped in history and mythology — as the sun sets.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 2</div>
          <div class="day-content">
            <div class="day-title">Gorakhpur to Pokhara (280 km / ~10 hrs)</div>
            <div class="day-text">Cross the India–Nepal border and venture into Nepal's lush valleys and towering peaks. Arrive in Pokhara where the tranquil Phewa Lake mirrors the grandeur of the Annapurna range. A Himalayan oasis like no other.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 3</div>
          <div class="day-content">
            <div class="day-title">Pokhara — Permits & Exploration</div>
            <div class="day-text">Secure the necessary permits for Muktinath. Explore Pokhara's lakeside, café culture, and stunning Himalayan panoramas. An essential rest and preparation day before the high-altitude drive ahead.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 4</div>
          <div class="day-content">
            <div class="day-title">Pokhara to Muktinath (180 km / ~8 hrs)</div>
            <div class="day-text">Drive through the rugged Annapurna region, ascending through dramatic twists and cascading waterfalls. Arrive at the sacred Muktinath Temple at 3,710m — revered by both Hindus and Buddhists.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 5</div>
          <div class="day-content">
            <div class="day-title">Muktinath to Pokhara (180 km / ~8 hrs)</div>
            <div class="day-text">After a soulful morning at Muktinath Temple, begin the descent through Mustang's dramatic valleys. The landscape shifts from barren heights to lush green hills as you return to Pokhara's lakeside calm.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 6</div>
          <div class="day-content">
            <div class="day-title">Pokhara to Kathmandu via Manakamana (200 km / ~8 hrs)</div>
            <div class="day-text">En route to Kathmandu, stop at the sacred Manakamana Temple — accessible by a thrilling cable car ride over lush valleys and the Trishuli River. Arrive in Nepal's vibrant capital by evening.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 7</div>
          <div class="day-content">
            <div class="day-title">Kathmandu Exploration</div>
            <div class="day-text">Visit Pashupatinath Temple on the Bagmati River, the magnificent Boudhanath Stupa, and the historic Kathmandu Durbar Square. End the day exploring Thamel's lively markets and cafés.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 8</div>
          <div class="day-content">
            <div class="day-title">Kathmandu to Gorakhpur (330 km / ~9 hrs)</div>
            <div class="day-text">Begin the return to India through Nepal's scenic hills and Terai plains. Cross the Sunauli border and reach Gorakhpur — the final halt of the Nepal expedition.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 9</div>
          <div class="day-content">
            <div class="day-title">Gorakhpur to Home</div>
            <div class="day-text">The final drive home, with optional stops at Shri Krishna Janmabhoomi in Mathura and the timeless Taj Mahal in Agra — a fitting end to an extraordinary Himalayan journey.</div>
          </div>
        </div>
        </div>
      </div>
...
<!-- PHOTO GALLERY -->
<section class="trip-gallery" id="gallery-nepal">
  <div class="trip-gallery-heading">Photo Gallery</div>
  <div class="trip-gallery-sub">Moments from the road</div>
  <div class="tg-track" id="tgTrack-nepal">
      <div class="tg-slide" onclick="tgOpenLB('nepal',0)">
        <img src="https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=1200&q=80" alt="Annapurna Circuit drive" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('nepal',1)">
        <img src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&q=80" alt="Pokhara valley views" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('nepal',2)">
        <img src="https://images.unsplash.com/photo-1522163182402-834f871fd851?w=1200&q=80" alt="Himalayan village Nepal" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('nepal',3)">
        <img src="https://images.unsplash.com/photo-1458442310124-dde6edb43d10?w=1200&q=80" alt="Forest mountain Nepal" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('nepal',4)">
        <img src="https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1200&q=80" alt="Stars over Nepal peaks" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('nepal',5)">
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80" alt="Snow peaks Nepal" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
  </div>
  <div class="tg-controls">
    <button class="tg-btn" onclick="tgScroll('nepal',-1)">&#8592;</button>
    <button class="tg-btn" onclick="tgScroll('nepal',1)">&#8594;</button>
  </div>
</section>
<script>
var tgData = tgData || {};
tgData['nepal'] = [
        {src:"https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=1200&q=80",cap:"Annapurna Circuit drive"},
        {src:"https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&q=80",cap:"Pokhara valley views"},
        {src:"https://images.unsplash.com/photo-1522163182402-834f871fd851?w=1200&q=80",cap:"Himalayan village Nepal"},
        {src:"https://images.unsplash.com/photo-1458442310124-dde6edb43d10?w=1200&q=80",cap:"Forest mountain Nepal"},
        {src:"https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1200&q=80",cap:"Stars over Nepal peaks"},
        {src:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80",cap:"Snow peaks Nepal"}
];
      ...
      <div class="sidebar">
        <div class="pay-panel">
          ...
          <div class="price-strip">
            <div class="ps-item"><div class="ps-label">Self Drive</div><div class="ps-val">₹40,999</div><div class="ps-note">per person · twin sharing</div></div>
            <div class="ps-item"><div class="ps-label">Couple Discount</div><div class="ps-val">₹34,999</div><div class="ps-note">per person</div></div>
            <div class="ps-item"><div class="ps-label">Seat Sharing</div><div class="ps-val">₹49,999</div><div class="ps-note">per person</div></div>
          </div>
          ...
          <div class="pay-body">
            ...
            <a href="https://wa.me/917817838060?text=Hi%21%20I%20want%20to%20book%20the%20Soulful%20Nepal%20Odyssey%20expedition.%20Please%20confirm%20my%20payment." target="_blank" class="wa-confirm-btn">💬 Send Payment Screenshot</a>
          </div>
        </div>
...
<section style="background:rgba(42,122,110,.08);border-top:1px solid rgba(42,122,110,.25);border-bottom:1px solid rgba(42,122,110,.25);padding:60px 5vw">
  <div style="max-width:760px;margin:0 auto;text-align:center">
    ...
    <div>
      <a href="https://wa.me/917817838060?text=Hi%20FreeWheel!%20I'm%20interested%20in%20Overlanding%20for%20the%20Upper%20Mustang%20expedition." target="_blank" class="btn-ghost" style="border-color:var(--rust);color:var(--rust)">Still want to ask anything? 💬 WhatsApp</a>
    </div>
  </div>
</section>
...
<section style="background:var(--rust);padding:60px 5vw;text-align:center">
  ...
  <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap">
    ...
    <a href="/cdn-cgi/l/email-protection#cda5a8a1a1a28dabbfa8a8baa5a8a8a1a8b5bda8a9a4b9a4a2a3bee3a4a3" class="btn-ghost" style="border-color:rgba(255,255,255,.5);color:#fff">✉ Email Us</a>
  </div>
  <p style="margin-top:20px;font-size:13px;color:rgba(255,255,255,.7);font-weight:300"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="741c1118181b3412061111031c111118110c0411101d001d1b1a075a1d1a">[email&#160;protected]</a> · +91 78178 38060 · +91 78382 95852</p>
</section>

<?php fw_faq_section("nepal"); ?>
