<?php
/**
 * Template Name: Dream Leh Ladakh
 * Template Post Type: page
 *
 * FreeWheel Expeditions — Dream Leh Ladakh
 * Template: page-leh
 */
get_header(); ?>
<style>
...
.trip-hero{min-height:72vh;background:linear-gradient(145deg, #0a1a12 0%, #1a2808 50%, #0f1208 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:100px 5vw 60px;position:relative;overflow:hidden}
...
<img id="tripHeroImg" src="" alt="Leh Ladakh Self Drive Expedition 2026" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center;display:none;opacity:0.4;z-index:0">
<div class="trip-hero-content" style="position:relative;z-index:1">
    ...
    <h1 class="trip-h1">Leh Ladakh Self Drive Expedition 2026</h1>
    <p class="trip-sub">The Land of High Passes — where barren deserts meet pristine blue lakes and ancient monasteries</p>
    <div class="trip-quick">
      <div class="tq-item"><div class="tq-label">Duration</div><div class="tq-val">15 Nights / 16 Days</div></div>
      <div class="tq-item"><div class="tq-label">Upcoming Dates</div><div class="tq-val">August 2026</div></div>
      <div class="tq-item"><div class="tq-label">Starting From</div><div class="tq-val">₹34,999/person</div></div>
  ...
  <div class="trip-main">
    <div class="trip-grid">
      ...
      <div>
        ...
        <p class="overview-p">Leh Ladakh, often referred to as the 'Land of High Passes', is a mesmerizing region nestled in the northernmost part of India amidst the towering Himalayan and Karakoram mountain ranges. Known for its rugged terrain, stunning landscapes, and unique cultural heritage, it has captured the hearts of travellers worldwide.</p><p class="overview-p">The region's stark beauty is characterised by barren deserts, pristine blue lakes, ancient monasteries, and picturesque villages that seem to emerge like oases. The high-altitude passes such as Khardung La and Chang La provide exhilarating journeys and panoramic vistas — a paradise for self-drive enthusiasts.</p><p class="overview-p">A visit to Leh Ladakh is not just a physical journey but also a spiritual and emotional one, leaving an indelible mark on all who have the privilege of experiencing its unique charm.</p>
        ...
        <div class="day-item">
          ...
          <div class="day-content">
            <div class="day-title">Delhi to Manali (550 km / ~13 hrs)</div>
            <div class="day-text">Traverse from Delhi's urbanity through Haryana, Punjab, the Shivalik Hills, and Kullu, ascending into the majestic Himalayan heights of Manali. A journey of diverse landscapes and cultures.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 2</div>
          <div class="day-content">
            <div class="day-title">Manali to Sarchu (200 km / ~8 hrs)</div>
            <div class="day-text">Through Rohtang Pass and Baralacha La into the high-altitude desert campsite of Sarchu — nestled at the border of Himachal Pradesh and Ladakh.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 3</div>
          <div class="day-content">
            <div class="day-title">Sarchu to Leh (250 km / ~7 hrs)</div>
            <div class="day-text">Cross the Gata Loops, Nakee La, Lachung La, and Tanglang La (world's second highest motorable pass) before descending into Leh — Ladakh's cultural and administrative heart.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 4</div>
          <div class="day-content">
            <div class="day-title">Leh — Rest Day</div>
            <div class="day-text">Explore Thiksey and Hemis monasteries, the bustling bazaars, Leh Palace, and soak in the serene Tibetan Buddhist ambiance of this remarkable capital.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 5</div>
          <div class="day-content">
            <div class="day-title">Places Around Leh</div>
            <div class="day-text">Visit Magnetic Hill, Sangam (confluence of Zanskar & Indus), Pathar Sahib Gurudwara, Leh Palace, and the iconic Shanti Stupa.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 6</div>
          <div class="day-content">
            <div class="day-title">Leh to Nubra Valley (160 km / ~6 hrs)</div>
            <div class="day-text">Ascend Khardung La — one of the world's highest motorable roads. Descend into Nubra Valley's sand dunes, Bactrian camels, and the Diskit Monastery with its towering Maitreya Buddha.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 7</div>
          <div class="day-content">
            <div class="day-title">Nubra to Pangong Tso (280 km / ~8 hrs)</div>
            <div class="day-text">Return over Khardung La and wind through remote villages to reach the legendary Pangong Tso — the vivid blue lake that straddles the India–China border.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 8</div>
          <div class="day-content">
            <div class="day-title">Pangong to Hanle (160 km / ~7 hrs)</div>
            <div class="day-text">Into Changthang Plateau's hidden realm. Arrive in Hanle, home to the Indian Astronomical Observatory — one of the world's highest observatories.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 9</div>
          <div class="day-content">
            <div class="day-title">Umling La Expedition (200 km / ~6 hrs)</div>
            <div class="day-text">Conquer Umling La — the world's highest motorable pass at over 19,000 feet. Return to Hanle with the profound experience of the roof of the world.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 10</div>
          <div class="day-content">
            <div class="day-title">Hanle to Leh (300 km / ~7 hrs)</div>
            <div class="day-text">Cross the vast Changthang Plateau, descending through Chumathang and Hemis. A passage from solitude back to civilisation.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 11</div>
          <div class="day-content">
            <div class="day-title">Leh to Kargil (220 km / ~6 hrs)</div>
            <div class="day-text">Trace the historic Srinagar–Leh Highway through Fotu La and Namika La. Visit the Kargil War Memorial — a tribute to India's heroes.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 12</div>
          <div class="day-content">
            <div class="day-title">Kargil to Srinagar (200 km / ~6 hrs)</div>
            <div class="day-text">Cross Zoji La Pass — gateway between Ladakh and Kashmir. Through Sonamarg and Drass, arriving in the enchanting Srinagar nestled on Dal Lake.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 13</div>
          <div class="day-content">
            <div class="day-title">Srinagar Exploration</div>
            <div class="day-text">Dal Lake, Mughal Gardens, the historic Jamia Masjid, traditional Kashmiri cuisine, and the timeless charm of Kashmir's summer capital.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 14</div>
          <div class="day-content">
            <div class="day-title">Srinagar to Jammu (250 km / ~8 hrs)</div>
            <div class="day-text">Descend from Srinagar's serenity through picturesque valleys and terraced fields to Jammu's bustling markets and historic temples.</div>
          </div>
        </div>
        <div class="day-item">
          <div class="day-num">Day 15</div>
          <div class="day-content">
            <div class="day-title">Jammu to Delhi (600 km / ~12 hrs)</div>
            <div class="day-text">The final leg — from Jammu through Punjab's lush fields back to Delhi, bridging the journey from the Himalayas to the capital.</div>
          </div>
        </div>
        </div>
      </div>
...
<!-- PHOTO GALLERY -->
<section class="trip-gallery" id="gallery-leh">
  <div class="trip-gallery-heading">Photo Gallery</div>
  <div class="trip-gallery-sub">Moments from the road</div>
  <div class="tg-track" id="tgTrack-leh">
      <div class="tg-slide" onclick="tgOpenLB('leh',0)">
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&q=80" alt="Pangong Lake Ladakh" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('leh',1)">
        <img src="https://images.unsplash.com/photo-1587474260584-136574528ed5?w=1200&q=80" alt="Thiksey Monastery Leh" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('leh',2)">
        <img src="https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1200&q=80" alt="Camping Ladakh" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('leh',3)">
        <img src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=80" alt="Khardung La pass" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('leh',4)">
        <img src="https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?w=1200&q=80" alt="Leh Ladakh highway" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
      <div class="tg-slide" onclick="tgOpenLB('leh',5)">
        <img src="https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=1200&q=80" alt="Nubra Valley dunes" loading="lazy">
        <div class="tg-slide-overlay">🔍</div>
      </div>
  </div>
  <div class="tg-controls">
    <button class="tg-btn" onclick="tgScroll('leh',-1)">&#8592;</button>
    <button class="tg-btn" onclick="tgScroll('leh',1)">&#8594;</button>
  </div>
</section>
<script>
var tgData = tgData || {};
tgData['leh'] = [
        {src:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&q=80",cap:"Pangong Lake Ladakh"},
        {src:"https://images.unsplash.com/photo-1587474260584-136574528ed5?w=1200&q=80",cap:"Thiksey Monastery Leh"},
        {src:"https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1200&q=80",cap:"Camping Ladakh"},
        {src:"https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=80",cap:"Khardung La pass"},
        {src:"https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?w=1200&q=80",cap:"Leh Ladakh highway"},
        {src:"https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=1200&q=80",cap:"Nubra Valley dunes"}
];
      ...
      <div class="sidebar">
        <div class="pay-panel">
          ...
          <div class="price-strip">
            <div class="ps-item"><div class="ps-label">Self Drive</div><div class="ps-val">₹34,999</div><div class="ps-note">per person · twin sharing</div></div>
            
            <div class="ps-item"><div class="ps-label">Seat Sharing</div><div class="ps-val">₹39,999</div><div class="ps-note">per person</div></div>
          </div>
          ...
          <div class="pay-body">
            ...
            <a href="https://wa.me/917817838060?text=Hi%21%20I%20want%20to%20book%20the%20Dream%20Leh%20Ladakh%20expedition.%20Please%20confirm%20my%20payment." target="_blank" class="wa-confirm-btn">💬 Send Payment Screenshot</a>
          </div>
        </div>

          <div class="pc-alt"><span class="pc-alt-label">Seat Sharing</span><span class="pc-alt-price">&#8377;39999/person</span></div>
          <button class="book-big" onclick="openBookNow('Dream Leh Ladakh',34999,'August 2026')">Book Now →</button>
          <p style="font-size:11px;color:rgba(255,255,255,.35);font-weight:300;margin-top:10px;text-align:center;line-height:1.5">50% partial payment option available at checkout</p>
        </div>

        <div class="dates-card">
          <div class="dc-label">Upcoming Dates</div>
          <div class="dc-date">August 2026</div>
          <div class="dc-note">DM or WhatsApp for exact dates &amp; availability</div>
          <div style="margin-top:14px">
            <a href="https://wa.me/917817838060?text=Hi! I am interested in Dream Leh Ladakh" target="_blank" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:11px;background:#25d366;color:#fff;text-decoration:none;font-family:var(--headline);font-size:15px;letter-spacing:1px;border-radius:2px">💬 WhatsApp Us</a>
          </div>
        </div>
...
<section style="background:var(--rust);padding:60px 5vw;text-align:center">
  ...
  <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap">
    ...
    <a href="/cdn-cgi/l/email-protection#98f0fdf4f4f7d8feeafdfdeff0fdfdf4fde0e8fdfcf1ecf1f7f6ebb6f1f6" class="btn-ghost" style="border-color:rgba(255,255,255,.5);color:#fff">✉ Email Us</a>
  </div>
  <p style="margin-top:20px;font-size:13px;color:rgba(255,255,255,.7);font-weight:300"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7f171a1313103f190d1a1a08171a1a131a070f1a1b160b1610110c511611">[email&#160;protected]</a> · +91 78178 38060 · +91 78382 95852</p>
</section>

<?php fw_faq_section("leh"); ?>
